local words2omit = {["!"] = 177, ["#"] = 2930, ["$"] = 314, ["%"] = 139, ["&#91;"] = 312, ["&#93;"] = 316, ["&amp;"] = 482, ["&apos;"] = 92, ["&apos;an"] = 9189, ["&apos;d"] = 1069, ["&apos;i"] = 5286, ["&apos;ll"] = 566, ["&apos;m"] = 808, ["&apos;re"] = 358, ["&apos;s"] = 26, ["&apos;t"] = 85, ["&apos;ve"] = 555, ["&gt;"] = 730, ["&lt;"] = 2691, ["&quot;"] = 12, ["("] = 35, [")"] = 33, ["*"] = 339, ["+"] = 795, [","]
...
--去除'\13'
function replaceDelimiter(text)
    -- returns an array of fields based on text and delimiter (one character only)
    local result = ""
    local pattern = "[^".."\13".."]+"
    for w in string.gmatch(text, pattern) do
